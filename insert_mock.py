...
볼링 : 볼링을 좋아하는 학우라면 부담없이 들을 수 있음 2학점""",
    ...
    {
        "name": "새내기 수강신청·시간표 가이드",
        "description": "신입생을 위한 학점별 교양/전공 이수 요건, 추천 시간표 조합, 수강신청 성공 전략 안내",
        "model_name": "gpt-4o",
        "system_prompt": "공강·오전 수업 관련 현실적인 조언, 졸업요건 기반의 필수 과목 추천, 경쟁이 심한 과목의 대체안 제시.",
        "documents": [
            {
                "filename": "freshman_scheduler_guide.pdf",
                "file_type": "pdf",
                "content": """[시간표 짜는 추천 순서]
- 1순위: 전공 과목 (학과 지정 필수 과목 먼저 배치)
- 2순위: 대학생활과 진로설계 (대진설, 1학년 필수)
- 3순위: 공통/핵심교양 (대학글쓰기 등 경쟁 심한 과목)
- 4순위: 일반교양 (남는 시간에 채우기)

[핵심 조언 요약]
- 졸업요건 확인: 시간표 짜기 전 통합정보시스템에서 졸업요건 확인 필수.
- 공강 확보: 삶의 질 향상을 위해 '금공강' 등 주 1회 공강을 적극 추천. 단, 하루 4과목 이상은 피할 것.
- 9시 수업 최소화: 대학 생활 적응을 위해 10시 이후 수업 위주로 배치 권장.
- 경쟁과목 주의: '대학글쓰기'(구 기초글쓰기)와 인기 교양은 수강신청이 매우 치열하므로 여러 대안을 준비해야 함.

[학점 및 이수 관련]
- 이수학점: 신입생은 최대 18학점 신청 가능. (직전 학기 평점 3.75 이상 시 다음 학기 21학점 가능)
- 국가장학금: 최소 이수학점 및 성적 기준(예: 12학점, 평균 2.51 이상)을 충족해야 하므로 주의.

[2025년 주요 변경사항]
- 교양 기준 변경: 기존 '공통기초/핵심/일반교양'에서 '소양필수' 등으로 명칭 및 이수 기준이 변경됨.
- 필수 확인: 수강신청 전, 반드시 학교 공지의 최신 교양 이수 기준을 확인할 것.""",
            }
        ],
    },
]
